...
export const PROVIDER_PRESETS: ProviderPreset[] = [
  ...
  {
    id: "mistral",
    label: "Mistral AI / Codestral",
    baseUrl: "https://api.mistral.ai/v1",
    defaultModel: "codestral-latest",
    fallbackModels: ["codestral-latest", "mistral-large-latest", "mistral-small-latest"],
  },
  {
    id: "sambanova",
    ...
    fallbackModels: ["Meta-Llama-3.3-70B-Instruct", "Qwen2.5-Coder-32B-Instruct"],
  },
  {
    id: "siliconflow",
    label: "SiliconFlow",
    ...
    fallbackModels: ["Qwen/Qwen2.5-Coder-32B-Instruct", "deepseek-ai/DeepSeek-V3"],
  },
  {
    id: "custom",
    label: "Custom OpenAI Endpoint (Ollama / proxy)",
